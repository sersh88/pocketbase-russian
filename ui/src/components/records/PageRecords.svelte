<script>
    ...
    $: $pageTitle = $activeCollection?.name || "Коллекции";
...
{:else if !$collections.length}
    <PageWrapper center>
        <div class="placeholder-section m-b-base">
            ...
            {#if $hideControls}
                <h1 class="m-b-10">У тебя пока нет коллекций.</h1>
            {:else}
                <h1 class="m-b-10">Создай первую коллекцию, чтобы добавлять записи!</h1>
                <button
                    type="button"
                ...
                >
                    <i class="ri-add-line" />
                    <span class="txt">Создать коллекцию</span>
                </button>
            {/if}
        </div>
    </PageWrapper>
    ...
    <PageWrapper class="flex-content">
        <header class="page-header">
            <nav class="breadcrumbs">
                <div class="breadcrumb-item">Коллекции</div>
            ...
            <div class="inline-flex gap-5">
                {#if !$hideControls}
                    <button
                        ...
                        use:tooltip={{ text: "Редактировать коллекцию", position: "right" }}
            ...
            <div class="btns-group">
                ...
                >
                    ...
                    <span class="txt">Предпросмотр API</span>
                </button>
