...
<FullPage>
    {#if success}
        <div class="alert alert-success">
            ...
            <div class="content">
                <p>Проверь <strong class="txt-nowrap">{email}</strong> — я отправил туда ссылку для восстановления.</p>
            </div>
        </div>
    {:else}
        <form class="m-b-base" on:submit|preventDefault={submit}>
            <div class="content txt-center m-b-sm">
                <h4 class="m-b-xs">Забыли пароль суперпользователя</h4>
                <p>Введи email, привязанный к аккаунту, и я отправлю ссылку для восстановления:</p>
            </div>
            ...
            >
                ...
                <span class="txt">Отправить ссылку</span>
            </button>
        </form>
    {/if}
